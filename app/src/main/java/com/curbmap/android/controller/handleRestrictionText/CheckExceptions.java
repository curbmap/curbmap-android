...
public class CheckExceptions {
     ...
     * @param restrictionText  the RestrictionText object containing restriction information
     ...
     *                         restriction
     * @param restrictionText      the restriction object containing a lot of data
    ...
    public static int checkWarning(
        ...
        } else if (restrictionText.polyline == null) {
        ...
        } else if (restrictionText.type.equals("")) {
            return R.string.warning_no_type;
        } else if (restrictionText.type.equals(parkingMeter) && restrictionText.cost == -1) {
            return R.string.warning_no_cost;
        } else if (restrictionText.type.equals(parkingMeter) && restrictionText.per == -1) {
            return R.string.warning_no_per;
        } else if (restrictionText.type.equals(timeLimitParking) && restrictionText.time_limit == -1) {
            return R.string.warning_no_time_limit;
        } else if (restrictionText.type.equals("undefined")) {
            return R.string.warning_no_custom_type;
        } else if (restrictionText.type.equals(permitParkingDistricts)
                && restrictionText.permitDistrict.equals("undefined")) {
            return R.string.warning_no_permit_district;
        } else if (restrictionText.days.equals("0000000")) {
            return R.string.warning_no_days;
        } else if (!lengthIsSelected) {
            return R.string.warning_no_length;
        } else if (length.equals(withinHoursOf) && restrictionText.start_time.equals("undefined")) {
            return R.string.warning_no_from;
        } else if (length.equals(withinHoursOf) && restrictionText.end_time.equals("undefined")) {
