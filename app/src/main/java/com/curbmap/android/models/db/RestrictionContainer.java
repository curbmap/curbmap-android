...
public class RestrictionContainer {
     ...
     *
     * @param object  String of either restriction or restrictionImage object
    ...
    /**
     * Checks whether the current restriction is uploaded yet or not
     *
     * @return true if already uploaded to server, false otherwise
     */
